...
class BoxTypesControllerTest < ActionController::TestCase
  ...
  test "should create box_type" do
    assert_difference('BoxType.count') do
      post :create, box_type: { comment: @box_type.comment, max_position: @box_type.max_position, name: @box_type.name }
    end
  ...
  test "should update box_type" do
    patch :update, id: @box_type, box_type: { comment: @box_type.comment, max_position: @box_type.max_position, name: @box_type.name }
    assert_redirected_to box_type_path(assigns(:box_type))
  end
